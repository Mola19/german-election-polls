...
exports.allResults = exports.byParticipants = exports.byRelease = exports.Parliament = exports.Institute = exports.Method = exports.Tasker = void 0;
            ...
            case query_1.Order.Asc:
                sortFunc = (a, b) => {
                    if (a.method.id < b.method.id)
                        return -1;
                    else if (a.method.id > b.method.id)
                        return 1;
                    else
                        return 0;
                };
